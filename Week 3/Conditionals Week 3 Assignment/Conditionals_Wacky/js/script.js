...
//This is where the user inputted their choice of Destination
...
if (choiceA == null|| choiceA ==""){  //This verified if the user actually inputted one of the selction or skipped
console.log("No choice was selected for destination!");
}else{
    console.log("a number not on the list was picked")
}

//This is where the user selected their mode of transportation
...
if (choiceB == null|| choiceB =="") {   //This verified if the user actually inputted one of the selction or skipped
...
//Math = Distance/Vehicle
//Below I did the mathmatical equation for each combo of choices
...
}else  //This is my last line. I used this to make sure my loop worked
